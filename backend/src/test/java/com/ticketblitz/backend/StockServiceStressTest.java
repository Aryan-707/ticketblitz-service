        ...
        for (int i = 0; i < CONCURRENT_USERS; i++) {
            ...
            executor.submit(() -> {
                try {
                    ...
                    // The Action: Every thread uses the same seat and different idempotency key
                    boolean purchased = stockService.processPurchase(eventId, tierId, 1L, userId, java.util.UUID.randomUUID().toString());
